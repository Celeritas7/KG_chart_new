...
Abstract base class that all language-specific processors inherit from.
Each language implements its own logic for generating Devanagari and pronunciation.
"""
...
class ProcessedWord:
    ...
    Matches the kg_chart_vocabulary_translations table structure.
    """
